...
toyPed_ob = pedigree(toyPed$id, toyPed$father, toyPed$mother, toyPed$sex, affected=cbind(toyPed$affected, toyPed$avail))
...
```
Check that the answer you get accords with path-counting and show your work in tutorial
style. 

config2 = c("1", "0", "1", "1", "1")
names(config2)=c("201","203","206","207","214")
likehd(pedfile, 1/2, config2)

Are all these configurations necessary? 
Maybe pick just one more that is interesting
to discuss.
config3 = c("0", "1", "1", "0", "1")
likehd(pedfile, 1/2, config3)

config4 = c("1", "1", "0", "0", "0")
likehd(pedfile, 1/2, config4)
